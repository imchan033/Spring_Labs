...
public class NewArticleController {
	...
	public String submit(HttpServletRequest request) {
		...
		return "article/newArticleSubmittied";
	}
	
	2.parameter DTO 타입을 명시
	public String submit(NewArticleCommand command) {
	//동작원리 JSP(Userbean Action 태그 : setProperty)
	...
	1.2 위 원칙이 없어도 view 페이지에 DTO 객체가 자동으로 forward (KEY POINT : newArticleCommand)
